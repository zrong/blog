...
作为一个选择综合症+洁癖患者，在部署 Flash app 的时候着实有点纠结。互联网上能找到的教程都不怎么靠谱，要么太老，要么太乱连话都说不通顺，更别提那些转了无数手的资料了。 uwsgi 的参数别名众多，各种旧版本的配置也不尽相同，让急需把自己的 Flash 站点搭建到正式服务器上的新手们无所适从。
