...
但是，现在网上全面介绍这两种协议的中文文章并不多，或者说不够全面。我把我找到的 Socket 和 WebSocket 的相关资料做一个梳理，以方便理解。

限于篇幅，本文不可能很长。而且，技术细节并非所有人都愿意仔细了解的。但本文包含了大量的外部链接，跟随这些链接，可以找到足够多的细节，满足你/我的求知欲。
