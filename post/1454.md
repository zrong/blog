...
Postid: 1454
Slug: 1454
Nicename: %e5%b0%86%e5%9b%be%e5%83%8f%e7%9a%84%e9%80%8f%e6%98%8e%e5%8c%ba%e5%9f%9f%e8%bd%ac%e6%8d%a2%e4%b8%baalpha%e9%80%9a%e9%81%93%e5%8e%9f%e7%90%86
Category: technology
Tags: as3, bitmapdata, java

在[Sprite Sheep
Editor](http://zengrong.net/sprite_sheet_editor)中，使用了这样的一个小技术（思路来自[这里](http://www.riaidea.com/blog/archives/279.html)）：将透明图像的Alpha通道转换成黑白（灰度）图像，然后与正常图像拼合成一张大图，再存储成JPEG格式。
...
这些代码将 `_bmd`的Alpha通道信息分别复制到
`_channelBmd`的红绿蓝通道中，最终合成了一张代表Alpha通道的灰度图。
