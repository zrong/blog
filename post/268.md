...
IDE环境下显示trace()信息。为此我曾经寻找过许多具有类似功能的小软件，并写了[非IDE环境显示trace()内容](http://www.zengrong.net/?p=68)一文。这篇文章中需要下载一个名为[Flash7
...
Debug](http://www.zengrong.net/?p=68)，并且功能要强大数倍。
