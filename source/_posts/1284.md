...
我们知道，Object和Dictionary适合随机存取，而Array和Vector适合顺序存取（**关于Array和Vector的性能可以看这篇文章： **[Array/Vector/AS3DS/ds/dsforas性能比较](http://blog.zengrong.net/post/1260.html) ），但它们之间的性能差距有大呢？
